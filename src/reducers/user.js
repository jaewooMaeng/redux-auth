...
import { UPDATE_ACCOUNT_COMPLETE, UPDATE_ACCOUNT_AUTH, UPDATE_TFA_POSSIBLE, UPDATE_TFA_NOT_POSSIBLE } from '../actions/update-account';
...
export default createReducer(initialState, {
  ...
  [UPDATE_TFA_POSSIBLE]: (state) => state.set("editTfaPossible", true),

  [UPDATE_TFA_NOT_POSSIBLE]: (state) => state.set("editTfaPossible", false),
