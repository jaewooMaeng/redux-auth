...
import { UPDATE_ACCOUNT_COMPLETE, UPDATE_ACCOUNT_AUTH, UPDATE_AUTH_POSSIBLE, UPDATE_AUTH_NOT_POSSIBLE } from '../actions/update-account';
...
export default createReducer(initialState, {
  ...
  [UPDATE_AUTH_NOT_POSSIBLE]: (state) => state.set("editAuthPossible", false),
